...
(deftest-lock-file manual-manifest
  {:deps
   {'squint/squint
    {:deps/manifest :deps
...
(deftest-lock-file maestro-build-test
  {:deps
...
(deftest-lock-file maestro-test
  {:deps
   {'protosens/maestro
...
(deftest-lock-file metrics-test
  {:deps
...
(deftest-lock-file firebase-admin-test
  {:deps {'com.google.firebase/firebase-admin {:mvn/version "9.2.0"}}}
  (is (match?
...
(deftest-lock-file reitit-test
  {:deps {'metosin/reitit {:mvn/version "0.5.15"}}}
  (is (match?
...
(deftest-lock-file jitpack-extra-mvn-repos-test
...
(deftest-lock-file invalid-pom-test
  {:deps {'url-normalizer/url-normalizer {:mvn/version "0.5.3-1"}}}
  (is (match?
